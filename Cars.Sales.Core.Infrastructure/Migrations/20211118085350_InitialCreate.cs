        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Configuration_Gearbox_Gears = table.Column<int>(type: "int", nullable: true),
                    Configuration_Gearbox_Type = table.Column<int>(type: "int", nullable: true),
                    Configuration_Version = table.Column<int>(type: "int", nullable: true),
                    Configuration_Color = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
